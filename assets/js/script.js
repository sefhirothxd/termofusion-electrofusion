	...
	$('.contact-form form').submit(function (e) {
		...
		$.ajax({
			...
			success: function (json) {
				if (json.nameMessage != '') {
					nameLabel.append(
						' - <span class="red error-label"> ' + json.nameMessage + '</span>'
					);
				}
				...
				if (
					...
					form.fadeOut('fast', function () {
						form
							.parent('.contact-form')
							.append(
								'<p><span class="green">Gracias, tu mensaje ha sido enviado!</span> Nos pondremos en contacto contigo a la brevedad posible. <a href="http://www.teclesvital.com/">Actualizar</a></p>'
							);
					});
				}
			},
